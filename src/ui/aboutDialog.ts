/**
 * About Dialog UI Module
 * 关于对话框 UI 模块
 * 
 * Manages the creation, display, and interaction logic for the application's About dialog.
 * Provides functions to show and hide the dialog, which includes version info and tech details.
 * 管理应用程序"关于"对话框的创建、显示和交互逻辑。
 * 提供显示和隐藏对话框的功能，其中包含版本信息和技术细节。
 */
...
function createAboutDialog(): HTMLElement {
  ...
  infoContainer.innerHTML = `
    ...
    <p class="copyright">© 2025 ArtaphyLabs. 保留所有权利。</p>
  `;
 ...
 * 显示"关于"对话框。
 * 如果对话框不存在则创建它，将其和覆盖层添加到 DOM 中，并触发打开动画。
 */
 ...
 * 隐藏"关于"对话框。
 * 触发关闭动画，并在动画完成后从 DOM 中移除对话框和覆盖层。
 */
